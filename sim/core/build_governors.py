...
def _settlement_struct_counts(sid, sm, world):
    ...
    return farms, stor, gran, mine, road, workshop, barracks, market, temple, academy, walls, irrigation, total
...
def resolve_building(requested, agent_x, agent_y, sm, world) -> Tuple[str, str]:
    ...
    farms, stor, gran, mine, road, workshop, barracks, market, temple, academy, walls, irrigation, total = _settlement_struct_counts(best_sid, sm, world)
