...
def structure_counts(snap: dict) -> str:
    ...
    order = ["farm", "storage", "hut", "granary", "mine", "road",
             ...
             "irrigation", "library", "foundry", "hall"]
...
def print_grid(grid, tick, summary=None, snap=None, callouts=None):
    ...
    if summary:
        ...
        print(
            ...
            f"Y:{m.get('build_foundry',0)} O:{m.get('build_hall',0)}"
        )
    if snap:
    ...
    print("  #=walls ~=irrigation L=library Y=foundry O=hall")
    print()
