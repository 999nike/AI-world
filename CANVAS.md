...
2. Restore branch **v45**. **STAMP · v45**. First patch in that chat is **v46**.
3. Canvas live stamp is **· v45**.
...
7. Prove: page contains `id="begin"` and `· v45`. Prove `/sprites/train.png` is 200.
...
Live stamp: subtitle **Watch the ages. Four peoples. Same map. · v45**
...
See [PATCH_LEDGER.md](PATCH_LEDGER.md). Live **· v45**. Edicts hidden. Never Vite.
