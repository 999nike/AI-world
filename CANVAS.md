...
2. Restore branch **v45**. **STAMP · v45**. Live canvas may be **· v47**.
3. Canvas live stamp is **· v47**.
...
7. Prove: page contains `id="begin"` and `· v47`. Prove `/sprites/train.png` is 200.
...
Live stamp: subtitle **Watch the ages. Four peoples. Same map. · v47**
...
See [PATCH_LEDGER.md](PATCH_LEDGER.md). Live **· v47**. Pin **v45**. Edicts hidden. Never Vite.
