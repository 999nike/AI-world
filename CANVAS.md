...
2. Restore branch **v44**. Stamp **· v44**.
3. Canvas live stamp is **· v44**.
...
7. Prove: page contains `id="begin"` and `· v44`. Prove `/sprites/train.png` is 200.
...
Live stamp: subtitle **Watch the ages. Four peoples. Same map. · v44**
...
See [PATCH_LEDGER.md](PATCH_LEDGER.md). Live **· v44**. Edicts hidden. Never Vite.
