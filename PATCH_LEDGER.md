...
**Hand-off:** 2026-08-20 01:00 BST — **v29-safe is the restore pin.**
...
Old pin `v19-safe` / `5ce0355` is king+hall only. **Do not restore it.** Canvas v20–v29 lives on `v29-safe`.
...
LIVE play_web · · v29
  ...
  West gold · east silver · north steel · south moss
  Start 10 walkers a pole (cap 10)
  Ranks: knight / king / scribe / builder / rail crew
  Industry: mill on water, rail spine, warehouse, one wonder
  World city: airport, planes, taxi, bus
  Hold: first to observatory + 2 discoveries
```
...
- **Sit** with the world city (uni / bars as real buildings if it still reads as stand-ins).
- Not memory-app agents until the watch is solid.
- Not a new era. Not edicts. Not Vite.
